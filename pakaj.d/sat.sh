...
## See-Also: https://gricad-gitlab.univ-grenoble-alpes.fr/legi/soft/trokata/sat
## Description: Simple At like interface with systemd persistence
## Binaries: ls tail xargs reprepro git grep cut make pod2man

function oberpakaj_sat {
   local keep=$1; shift
   local distrib=$*
